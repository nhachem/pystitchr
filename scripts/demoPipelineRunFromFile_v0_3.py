...
pyspark
import demoPipelineRunFromFile_v0_3
or
python demoPipelineRunFromFile_v0_3.py
...
pipeline_spec = load_json_spec(f'{spec_dir}/demo_pipeline_v0_3.json')

json_df = spark.read.format("json").option("multiline", "true").load(f"../resources/json_test_v0_3.json")
print(json_df.count())
json_df.printSchema()
